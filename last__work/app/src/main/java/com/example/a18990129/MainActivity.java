...
import com.example.a18990129.bean.UserInfo;
import com.example.a18990129.database.UserDBHelper;
import com.example.a18990129.util.DateUtil;
import com.example.a18990129.util.ViewUtil;
...
public class MainActivity extends AppCompatActivity implements View.OnClickListener, View.OnFocusChangeListener {
    ...
    private String[] typeArray = {"个人用户", "公司用户","18990129_冯小川"};
    ...
    private class HideTextWatcher implements TextWatcher {
        ...
        public void afterTextChanged(Editable s) {
            ...
            if ((mStr.length() == 11 && mMaxLength == 11) ||
                ...
                ViewUtil.hideOneInputMethod(com.example.a18990129.MainActivity.this, mView);
            }
        }
    }
